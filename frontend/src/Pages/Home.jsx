    ...
    <>
      ...
      <div className='home1'>
        ...
        <div className='home-welcome'>
          ...
          <p className='parrafo-welcome'>Optimiza la gestión de tus proyectos con nuestra innovadora herramienta, simplifica la colaboración, seguimiento de tareas y maximiza la eficiencia en cada etapa del proyecto</p>
          <Link to="/user"><button type="submit" className="btn-login">
            Comenzar
          </button>
          </Link>
        </div>
